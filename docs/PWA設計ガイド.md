...
呼び出し場所：**P11-4（LIAISON+申込完了）** または **P3-15（クリエイター-LIAISONコンソール）** または **P4-14（ギャラリー-LIAISONコンソール）**
...
| イベント | 通知タイトル（案） | 受信者 |
|---|---|---|
| 購入申込が入った | 「〇〇 に購入申込が届きました」 | 展覧会オーナー（クリエイター/ギャラリー） |
| キューの順番が来た | 「購入手続きへお進みください」 | 購入申込者 |
| 在庫なしキャンセル | 「申込作品の在庫がありませんでした」 | 購入申込者 |
| 取引メッセージ受信 | 「新しいメッセージが届きました」 | 展覧会オーナー（クリエイター/ギャラリー） / 購入者 |
