...
| ID | ページ名 | L/L+ | guest | login | user+ | creator | gallery | admin | max-width |
|---|---|---|---|---|---|---|---|---|---|
| P2 | 展覧会概要 |  | R | R | R | R | R | R | --w-entity |
| P2-1 | 展覧会-スケジュール |  | R | R | R | R | R | R | --w-detail |
| P2-2 | 展覧会-開催場所 |  | R | R | R | R | R | R | --w-detail |
| P2-3 | 展覧会-詳細(関連イベント・在廊・などその他情報) |  | R | R | R | R | R | R | --w-detail |
| P2-4 | 展覧会-出展者 |  | R | R | R | R | R | R | --w-detail |
| P2-5 | 展覧会-リエゾン作品一覧 | L,L+ | R | R | R | R | R | R | --w-index |
| P2-11 | 展覧会-新規/編集/クローン |  |  |  |  | W | W | W | --w-article |
| P2-12 | 展覧会-インサイト |  |  |  |  | W | W | W | --w-article |
| P2-13 | 展覧会-広告作成 |  |  |  |  | W | W | W | --w-article |
| P2-14 | 展覧会-修正依頼 |  | W | W | W |  |  |  | --w-article |
| P2-15 | 展覧会-報告 |  | W | W | W |  |  |  | --w-article |
...
| ID | ページ名 | L/L+ | guest | login | user+ | creator | gallery | admin | max-width |
|---|---|---|---|---|---|---|---|---|---|
| P3 | クリエイター |  | R | R | R | R | R | R | --w-entity |
...
| ID | ページ名 | L/L+ | guest | login | user+ | creator | gallery | admin | max-width |
|---|---|---|---|---|---|---|---|---|---|
| P6 | 作品 |  | R | R | R | R | R | R | --w-entity |
| P6-1 | 作品-リエゾン出品時 | L | R | R | R | R | R | R | --w-entity |
| P6-2 | 作品-リエゾンプラス出品時 | L+ | R | R | R | R | R | R | --w-entity |
