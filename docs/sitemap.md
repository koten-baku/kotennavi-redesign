...
| P5-3 | ユーザー-興味あり!リスト |  |  | R | R | R | R | R | --w-detail | # |
| P5-4 | ユーザー-my コレクションルーム |  |  | R | R | R | R | R | --w-detail | # |
...
| P6-11 | 作品-新規/編集/クローン |  |  |  |  | W | W | W | --w-article | # |
