...
const PAGES = {
  ...
  'p3-1': { n: 'クリエイター-展覧会アーカイブ', w: '--w-detail', bc: [['Top', '/'], ['田中 透', '/p3'], ['展覧会アーカイブ', null]] },
  'p3-2': { n: 'クリエイター-記事一覧', w: '--w-detail', bc: [['Top', '/'], ['田中 透', '/p3'], ['記事一覧', null]] },
  'p3-3': { n: 'クリエイター-作品一覧', w: '--w-detail', bc: [['Top', '/'], ['田中 透', '/p3'], ['作品一覧', null]] },
  'p3-11': { n: 'クリエイター-編集', w: '--w-article', bc: [['Top', '/'], ['田中 透', '/p3'], ['編集', null]] },
  'p3-12': { n: 'クリエイター-インサート', w: '--w-article', bc: [['Top', '/'], ['田中 透', '/p3'], ['インサート', null]] },
  ...
  'p3-15': { n: 'クリエイター-リエゾンコンソール', w: '--w-detail', bc: [['Top', '/'], ['田中 透', '/p3'], ['リエゾンコンソール', null, 'lp']] },
  ...
  // P6 作品
  'p6': { n: '作品', w: '--w-entity', bc: [['Top', '/'], ['作品', '/p10-1'], ['春の記憶 #3', null]] },
  'p6-1': { n: '作品-リエゾン出品時', w: '--w-entity', bc: [['Top', '/'], ['作品', '/p10-1'], ['春の記憶 #3', null, 'l']] },
  'p6-2': { n: '作品-リエゾンプラス出品時', w: '--w-entity', bc: [['Top', '/'], ['作品', '/p10-1'], ['春の記憶 #3', null, 'lp']] },
